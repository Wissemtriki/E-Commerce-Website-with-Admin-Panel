...
<head>
   ...
   <?php include './register_hand.php'; ?>
</head>
<body>
    <nav>
        <div class="logo">
          <img src="images/home/logoo-removebg-preview.png" alt="HF" width="100px">
        </div>
        <ul>
          ...
          <li><a href="account new.html">Account</a></li>
          <li class="search-bar">
            <input type="text" placeholder="Search">
            <button type="submit" title="Search"><i class="fas fa-search"></i></button>
          </li>
          <li class="cart-icon"><a href="#"><img src="#" alt="Cart"></a></li>
        </ul>
      </nav>
